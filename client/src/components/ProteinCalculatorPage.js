...
const goals = [
  { value: 'maintenance', name: 'Maintenance', multiplier: 0.8, description: 'Maintain current weight' },
  { value: 'weight_loss', name: 'Weight Loss', multiplier: 1.0, description: 'Lose weight' },
  { value: 'muscle_gain', name: 'Muscle Gain', multiplier: 1.2, description: 'Build muscle' },
];
...
const ProteinCalculatorPage = () => {
  ...
  const calculateProtein = () => {
    ...
    const goalMultiplier = goals.find(g => g.value === goal)?.multiplier || 0.8;
    const proteinPerKg = 0.8 + (goalMultiplier - 0.8) * 1.4; // Scale from 0.8 to 2.2
    const proteinGrams = Math.round(weightKg * proteinPerKg);
    const proteinCals = proteinGrams * 4; // 1g protein = 4 kcal
    const proteinPercentage = Math.round((proteinCals / tdee) * 100);
    setResult({
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Calculate your daily protein needs based on your body weight, activity level, and fitness goals. Learn about protein's role in muscle building, weight management, and overall health.
          </p>
        </motion.div>
              ...
              >
                ...
                <div className="space-y-6">
                  <div className="text-center">
                    ...
                    <div className="text-sm text-gray-500 mt-1">({result.proteinCals} kcal, {result.proteinPercentage}% of daily calories)</div>
                  </div>
                  <div className="bg-white rounded-lg p-6">
                    <h4 className="font-semibold text-gray-900 mb-4 text-center">Protein per Body Weight</h4>
                    <div className="text-center text-orange-700 font-semibold text-lg mb-2">{result.proteinPerKg}g per kg</div>
                    <div className="text-sm text-gray-500">Based on your fitness goal</div>
                  </div>
                  <div className="bg-white rounded-lg p-6">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h4 className="font-semibold text-gray-900 mb-3">What is Protein?</h4>
              <p className="text-gray-600 mb-4">
                Protein is a macronutrient essential for building and repairing tissues, making enzymes and hormones, and supporting immune function. It's made up of amino acids, the building blocks of life.
              </p>
              <h4 className="font-semibold text-gray-900 mb-3">Recommended Intake</h4>
              <p className="text-gray-600 mb-4">
                Protein needs vary based on goals: 0.8g/kg for maintenance, 1.0-1.2g/kg for weight loss, and 1.2-2.2g/kg for muscle building. Active individuals and athletes may need more.
              </p>
            </div>
            <div>
              <h4 className="font-semibold text-gray-900 mb-3">Best Protein Sources</h4>
              <ul className="list-disc pl-5 text-gray-700 text-sm space-y-2">
                <li><strong>Animal Sources:</strong> Lean meats, fish, eggs, dairy products</li>
                <li><strong>Plant Sources:</strong> Legumes, nuts, seeds, quinoa, tofu</li>
                <li><strong>Supplements:</strong> Whey protein, casein, plant-based protein powders</li>
              </ul>
              <h4 className="font-semibold text-gray-900 mt-6 mb-3">Why Protein Matters</h4>
              <p className="text-gray-600 mb-4">
                Adequate protein intake supports muscle growth, aids in weight loss by increasing satiety, helps maintain muscle mass during calorie restriction, and supports overall health and recovery.
              </p>
            </div>
          </div>
        </motion.div>
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="text-sm text-amber-700">
                Protein calculations are based on information available in the public domain and are for educational purposes only. For personalized nutrition or health advice, consult with qualified healthcare professionals.
              </p>
            </div>
          </div>
        </motion.div>
